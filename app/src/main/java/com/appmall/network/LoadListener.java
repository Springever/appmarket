...
class LoadListener extends Handler implements EventHandler {
    ...
    private static final int HTTP_MAX_RETRY_COUNT = 1;
    ...
    protected synchronized void setCancel(boolean cancel) {
    	mCancelled = cancel;
    }
    ...
    LoadListener(Context context, String url, boolean synchronous, HttpTaskListener listener, int taskid, Looper looper) {
    	super(looper);
...
//		}
    ...
    private boolean ignoreCallbacks() {
        return (isCanceled() || /*mAuthHeader != null ||*/
